...
class MultiThreadedDownloadInstance extends RangeDownloadInstance {
	...
	private DynamicChunkSize chunkSize;

	MultiThreadedDownloadInstance(URL url, File output, @Nullable Map<String, String> headers, long initialChunkSize, ExecutorService executor) {
